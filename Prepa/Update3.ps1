...
Unregister-ScheduledTask -TaskName "ConfigNext3" -Confirm:$false -ErrorAction SilentlyContinue
...
$SchTskAction = New-ScheduledTaskAction -Execute "powershell.exe" -Argument "C:\users\admin\Install.ps1"
$SchTskPrincipal = New-ScheduledTaskPrincipal -UserId "admin" -LogonType ServiceAccount -RunLevel Highest
Register-ScheduledTask -TaskName "ConfigNext4" -Action $SchTskAction -Trigger $SchTskTrigger -Principal $SchTskPrincipal
