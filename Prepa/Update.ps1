...
Unregister-ScheduledTask -TaskName "ConfigNext" -Confirm:$false -ErrorAction SilentlyContinue
...
$SchTskAction = New-ScheduledTaskAction -Execute "powershell.exe" -Argument "C:\users\admin\Update2.ps1"
$SchTskPrincipal = New-ScheduledTaskPrincipal -UserId "admin" -LogonType ServiceAccount -RunLevel Highest
Register-ScheduledTask -TaskName "ConfigNext2" -Action $SchTskAction -Trigger $SchTskTrigger -Principal $SchTskPrincipal
